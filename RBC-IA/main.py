...
# leitura de .xlsx criação de dataFrame
df = pd.read_excel("base-dados.xlsx")

# conexão com SQLite
banco = sqlite3.connect('b.db')
cursor = banco.cursor()

# armazenando dados do dataFrame no banco
...
# loop principal (interface gráfica)
while True:
    janela, eventos, valores = sg.read_all_windows()

# tratamento de eventos p/ diferentes opções da interface
